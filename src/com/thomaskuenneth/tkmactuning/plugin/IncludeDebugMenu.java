...
/**
 * This plugin controls, if Safari shows a Debug menu.
 *
 * @author Thomas Kuenneth
 */
public class IncludeDebugMenu extends BooleanPlugin {

    public IncludeDebugMenu() {
        super(IncludeDebugMenu.class);
    }
}
